...
export const iapiBase = process.env.NODE_ENV === 'development' ? 'http://104.154.72.47' : 'http://104.154.72.47';
export const apiBase = process.env.NODE_ENV === 'development' ? 'http://104.155.147.144' : 'http://104.155.147.144';
