...
export const iapiBase = process.env.NODE_ENV === 'development' ? 'https://iapi.curtmfg.com' : 'https://iapi.curtmfg.com';
export const apiBase = process.env.NODE_ENV === 'development' ? 'https://goapi.curtmfg.com' : 'https://goapi.curtmfg.com';
