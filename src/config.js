...
export const apiBase = process.env.NODE_ENV === 'development' ? 'http://localhost:8081' : 'https://goapi.curtmfg.com/v3';
export const apiKey = process.env.API_KEY !== undefined && process.env.API_KEY !== 'undefined' ? process.env.API_KEY : 'You need an API_KEY';
