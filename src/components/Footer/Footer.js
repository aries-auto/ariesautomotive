                ...
                <div className={cx(s.root, 'row', 'footer-outer-row')}>
                    <div className={cx('col-xs-12', 'col-sm-3', 'col-md-3', 'col-lg-3')}>
                        ...
                        <address itemScope itemType="//schema.org/Organization">
                            ...
                            <span itemProp="name" className="addressName">ARIES Automotive</span>
                            <div className="addressInfo" itemProp="address" itemScope itemType="//schema.org/PostalAddress">
                    ...
                    <div className="col-xs-6 col-sm-3 col-md-2 col-lg-2 footerNav">
                        <ul className="nav">
                    ...
                    <div className="col-xs-6 col-sm-3 col-md-4 col-lg-3">
                        <div className="row col-lg-10 col-md-10 col-xs-8 social">
                    ...
                    <div className="col-xs-12 col-sm-3 col-md-3 col-lg-4">
                        <img src="https://storage.googleapis.com/aries-logo/ARIES%20Logo%20(1c_red%20on%20transparent).svg" alt="Aries Automotive" className="img-responsive footerLogo" />
                        <div className="clearfix">&nbsp;</div>
                        <br />
                        <span className="conditions">&copy; 1997 - {this.getYear()} ARIES AUTOMOTIVE <a href="/terms" className="terms">TERMS & CONDITIONS</a></span>
                    </div>
                </div>
            </footer>
        );
