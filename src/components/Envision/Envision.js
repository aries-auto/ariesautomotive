				...
				<div className="iconfig-container">
					<div className="container-fluid">
						<div className="container">
							...
							<div id="icf_page"></div>
							{this.props.protocol === 'https:' ? (<script src="https://ver1.iconfigurators.com/src/embed.cfm?ky=539D7C9D0B8B72F4966C"></script>) : (<script src="http://ver1.iconfigurators.com/src/embed.cfm?ky=539D7C9D0B8B72F4966C"></script>)};
						</div>
					</div>
				</div>
			</div>
