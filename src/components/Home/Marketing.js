			...
			<div className={cx(s.root, 'container', this.props.className)}>
				<div>
					...
					<div className={cx(s.ytWrapper)}>
						<iframe allowFullScreen="" frameBorder="0" height="315" src="https://www.youtube.com/embed/RsH5vaVF4w4?rel=0" width="420"></iframe>
					</div>
					<div className={cx(s.ytWrapper)}>
						<iframe allowFullScreen="" frameBorder="0" height="315" src="https://www.youtube.com/embed/8RaC5j5UT5w?rel=0" width="420"></iframe>
					</div>
				</div>
				<div>
