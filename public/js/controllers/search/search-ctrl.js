...
define(['./module'], function (module) {
	...
	module.controller('SearchController', ['$scope', 'SearchService', '$stateParams','$sce', '$location', '$anchorScroll', 'AppConfig', function($scope, SearchService, $stateParams, $sce, $location, $anchorScroll, AppConfig){
		$scope.parts = [];
		$scope.query = '';
